    ...
    public class ImGuiController : IDisposable
    {
        ...
        public static int CreateProgram(string name, string vertexSource, string fragmentSoruce)
        {
            ...
            if (success == 0)
            {
                ...
                Logger.Error(new ShaderException($"GL.LinkProgram had info log[{ name }]:\n{ info}"), "ImGuiController.CreateProgram");
            }
        ...
        private static int CompileShader(string name, ShaderType type, string source)
        {
            ...
            if (success == 0)
            {
                ...
                Logger.Error(new ShaderException($"GL.CompileShader for shader '{name}' [{type}] had info log:\n{info}"), "ImGuiController.CompileShader");
            }
