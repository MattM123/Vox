...
namespace Vox.Assets.Models
{
    public static class ModelLoader
    {
        ...
        public static void LoadModels()
        {
            ...
            models.Add(BlockType.GRASS_BLOCK  , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\grass.json"))      ,   BlockType.GRASS_BLOCK   ));
            models.Add(BlockType.DIRT_BLOCK   , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\dirt.json"))       ,   BlockType.DIRT_BLOCK    ));
            models.Add(BlockType.STONE_BLOCK  , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\stone.json"))      ,   BlockType.STONE_BLOCK   ));
            models.Add(BlockType.TEST_BLOCK   , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\testblock.json"))  ,   BlockType.TEST_BLOCK    ));
            models.Add(BlockType.TARGET_BLOCK , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\target.json"))     ,   BlockType.TARGET_BLOCK  ));
            models.Add(BlockType.LAMP_BLOCK   , new(JObject.Parse(File.ReadAllText(_assets + "BlockModels\\lamp.json"))       ,   BlockType.LAMP_BLOCK    ));
        }
