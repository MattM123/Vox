...
namespace Vox
{
    ...
    public class OpenSimplex
    {
        ...
        private static readonly long PRIME_X = 0x5205402B9270C86FL;
        private static readonly long PRIME_Y = 0x598CD327003817B5L;
        private static readonly long PRIME_Z = 0x5BCC226E9FA0BACBL;
        private static readonly long PRIME_W = 0x56CC5227E58F554BL;
        private static readonly long HASH_MULTIPLIER = 0x53A3F72DEEC546F5L;
        private static readonly long SEED_FLIP_3D = -0x52D547B2E96ED629L;
        private static readonly long SEED_OFFSET_4D = 0xE83DC3E0DA7164DL;

        private static readonly double ROOT2OVER2 = 0.7071067811865476;
        private static readonly double SKEW_2D = 0.366025403784439;
        private static readonly double UNSKEW_2D = -0.21132486540518713;

        private static readonly double ROOT3OVER3 = 0.577350269189626;
        private static readonly double FALLBACK_ROTATE_3D = 2.0 / 3.0;
        private static readonly double ROTATE_3D_ORTHOGONALIZER = UNSKEW_2D;

        private static readonly float SKEW_4D = -0.138196601125011f;
        private static readonly float UNSKEW_4D = 0.309016994374947f;
        private static readonly float LATTICE_STEP_4D = 0.2f;

        private static readonly int N_GRADS_2D_EXPONENT = 7;
        private static readonly int N_GRADS_3D_EXPONENT = 8;
        private static readonly int N_GRADS_4D_EXPONENT = 9;
        private static readonly int N_GRADS_2D = 1 << N_GRADS_2D_EXPONENT;
        private static readonly int N_GRADS_3D = 1 << N_GRADS_3D_EXPONENT;
        private static readonly int N_GRADS_4D = 1 << N_GRADS_4D_EXPONENT;

        private static readonly double NORMALIZER_2D = 0.01001634121365712;
        private static readonly double NORMALIZER_3D = 0.07969837668935331;
        private static readonly double NORMALIZER_4D = 0.0220065933241897;

        private static readonly float RSQUARED_2D = 0.5f;
        private static readonly float RSQUARED_3D = 0.6f;
        private static readonly float RSQUARED_4D = 0.6f;
