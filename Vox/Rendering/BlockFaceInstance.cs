...
namespace Vox.Rendering
{
    ...
    public struct BlockFaceInstance(Vector3 facePosition, BlockFace faceDirection, int textureLayer, int index, int lighting)
    {
        ...
        [FieldOffset(24)] public int lighting = lighting;                   // 4 bytes to store bitpacked light color value for emissive blocks
